...
declare type ISelectValue = string | number | object | any;
...
export declare class SelectBase extends BaseComponent<MbscSelectOptions, any> {
    ...
    _validate: ({ values, direction, wheels, index }: IScrollerValidateArgs) => {
        disabled?: object[];
        valid?: IScrollerRepresentation;
        indexes?: IScrollerRepresentation;
    };
    /** @hidden */
     ...
     */
    private _filter;
    static ɵfac: i0.ɵɵFactoryDeclaration<SelectBase, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<SelectBase, "[mbsc-sel-b]", never, {}, {}, never>;
}
export {};
