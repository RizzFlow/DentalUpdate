...
import { MbscSelectOnFilterEvent } from '../../core/components/select/select.types.public';
...
export declare class MbscSelectOptionDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MbscSelectOptionDirective, "[mbsc-select-option]", never, {}, {}, never>;
}
...
export declare class MbscSelect extends MbscSelectBase {
    set vScroller(scroller: MbscScroller);
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MbscSelect, "mbsc-select", never, {}, {}, ["optionComponents"], never>;
}
export declare class MbscSelectDirective extends MbscSelectBase {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MbscSelectDirective, "[mbsc-select]", ["mobiscroll"], { "options": "mbscOptions"; "inputElement": "inputElement"; }, {}, ["optionElements"]>;
}
