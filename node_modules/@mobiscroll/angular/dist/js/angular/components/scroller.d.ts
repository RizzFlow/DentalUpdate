...
export declare class MbscScroller extends ScrollerBase {
    ...
    element?: any;
    writeValue?: (elm: HTMLInputElement, text: string, value: any) => boolean;
